...
import { EXECUTION_LANGUAGE_CONFIG, EXECUTABLE_LANGUAGES } from '../config/languages.js';
...
export const executeCode = async (language, code, stdin = '') => {
  const langConfig = EXECUTION_LANGUAGE_CONFIG[language.toLowerCase()];
...
export const SUPPORTED_LANGUAGES = EXECUTABLE_LANGUAGES;
